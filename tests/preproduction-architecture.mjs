...
assert.match(html,/paperchalk-build" content="debug-tilt-r48"/,'debug-tilt build cache key missing');
assert.match(html,/const BUILD = "debug-tilt-r48"/,'page redirect cache key must match runtime build');
