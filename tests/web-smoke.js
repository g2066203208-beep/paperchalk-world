...
assert(css.includes("Locked 128px side-view cutaway block"), "Side-view ground implementation missing");
...
assert(css.includes("--road-tex-x"), "Road texture phase variable missing");
assert(game.includes("setProperty('--road-tex-x'"), "Road texture is not world-anchored across 128px tiles");
